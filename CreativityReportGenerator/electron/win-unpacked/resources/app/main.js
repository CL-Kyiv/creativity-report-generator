...
function createWindow() {
    ...
    electron_1.ipcMain.on('open-file-dialog', function (event) {
        electron_1.dialog.showOpenDialog({ properties: ['openDirectory'] })
            .then(function (result) {
            var filepath = result.filePaths[0].toString();
